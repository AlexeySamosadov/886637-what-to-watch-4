...
import FilmInfoDescriptionDetails from "./film-info-description-details";
...
it(`Correctly render component FilmInfoDescriptionDetails`, () => {
  const tree = renderer.create(
      <FilmInfoDescriptionDetails
